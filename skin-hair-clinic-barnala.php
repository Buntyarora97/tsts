...
<head>
    ...
    <title>Skin and Hair Clinic in Barnala | Mob 99140 32355</title>
    <meta name="description" content="Looking for the best skin and hair treatments in Barnala? Dr. P.S. Nagpal Clinic offers advanced skincare, hair restoration, laser treatments, and more. Call 99140 32355." />
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="about-content text-center">
                        ...
                        <h3 class="sub-title">
                            Barnala Premier Skin and Hair Care Destination
                        </h3>
                        <p class="about-text">
