									...
									<tbody>
										<tr>
											...
											<td class='hidden-350'>	<iframe width="100%" height="150px" src="<?php echo $row['linkurl'];?>" allowfullscreen=""></iframe></td>
												<td class='hidden-350'><?php echo $row['linktype'];?></td>
											<td class='hidden-480'><a class="btn btn-primary" href="update-vid-link.php?id=<?php echo $row['linkid'];?>">Update</a></td>
											<td class='hidden-480'><a class="btn btn-danger" href="delete-vid-link.php?id=<?php echo $row['linkid'];?>">Delete</a></td>
										</tr>
									</tbody>
									  <?php } ?>
								</table>
