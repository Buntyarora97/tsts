			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="add-treatment.php">Add Treatment Image</a>
						</li>
					</ul>
									 ...
									 <?php 
											...
											$imgurltmp="";
											  if(isset($_POST['btn']))
											  {
												  ...
												  $sql="Insert into tbimg (imgnam,imgurl,imgsta,imgtyp) values ('$imgnam','$imgurl','Active','Treatment')";
												  if(mysqli_query($con,$sql))
												  {
												   echo "<script> alert('Recent Treatment Added Successfully');</script>";
