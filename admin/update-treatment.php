				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box box-color">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>Update Treatment Images Form</h3>
							</div>
									 ...
									 <?php 
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-9">
												<img src="images/upload/treatment/<?php echo $row['imgurl'];?>" alt="" height="150">
							 ...
							 <?php 
											include('connection.php');
											  if(isset($_POST['btn']))
											  {
                                                  ...
                                                  echo '<script>window.location.href = "show-treatment.php";</script>';
												  }
												  else
												  {
												 mysqli_error($con);
												  ...
												  if(mysqli_query($con,$sql))
												  {
												   echo "<script> alert('Treatment Image Updated Successfully');</script>";
												  move_uploaded_file($imgurltmp,'images/upload/treatment/'.$imgurl);
                                                  echo '<script>window.location.href = "show-treatment.php";</script>';
												  }
												  else
												 {
